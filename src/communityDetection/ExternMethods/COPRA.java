...
public class COPRA extends CommunityMiner{
    ...
    public LinkedList<Community> findCommunities2(String filePath,int nbrepeat/**default 1**/,int v/**Max degree of overlapping**/
                                                  , boolean nosplit/**Do not split discontiguous communities into contiguous subsets.**/ 
