...
public class EvolutionUtils {
    ...
    public static void main(String[] args){
        ...
        String tabname="GED";
        int nbtimeframe=44;
        writeEvolutionChain(BDpath, BDfilename, tabname,nbtimeframe/**nbre timeframes**/);
    }
    
    
    /**A method to generate evoltion chains tables**/
    public static void writeEvolutionChain(/*LinkedList<TimeFrame> dynamicNetwork,*/String BDpath,String BDfilename,String tabname,int nbtimeframe/**nbre timeframes**/){
